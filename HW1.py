...
#I hope that's all the packages needed 
#I deleted a few I thought I didn't use
...
def DGP(N=1000, M=1000, alpha=0, beta_1=1, beta_2=0.1, rho=0.9):
    ...
    plt.hist([l[0] for l in coefX_1], bins=20) #chosen model
    plt.hist([l[1] for l in coefX_1], alpha = 0.5, bins=20) #unrestricted model
